...
def sectionHeader():
    ...
    return ft.Column([
        ...
        ft.Text("Extrator NF-e", size=28, weight=ft.FontWeight.W_600, color=th["TEXT"], text_align=ft.TextAlign.CENTER),
...
def sectionDrop(on_click):
    ...
    return ft.Container(
        content=ft.Column([
            ...
            ft.Text("Arquivos XML de NF-e", size=14, color=th["TEXT_SECONDARY"])
