        ...
        return ft.Column([
            ...
            mainCard([
                completedCard(
                    ...
                    erros=state['erros'],
                    lista_erros=state['lista_erros'],
                    lista_cancelados=state['lista_cancelados'],
    ...
    def iniciarProcessamento():
        ...
        def processar():
            ...
            if resultado["status"] == "sucesso":
                ...
                state["lista_erros"] = resultado["lista_erros"]
                state["lista_cancelados"] = resultado["lista_cancelados"]
            else:
